    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="mb-16">
        <div className="grid gap-8 md:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mb-4 text-muted-foreground">
              Driven by the vision of a unified, all-in-one solution, they assembled a team of top-tier developers, designers, and business experts. Together, we've created a platform that streamlines every aspect of business management, from employee productivity to financial oversight.
            </p>
      ...
      <section className="text-center">
        ...
        <p className="mb-6 text-muted-foreground">
          We're always looking for talented individuals to join our team and help shape the future of business management.
        </p>
