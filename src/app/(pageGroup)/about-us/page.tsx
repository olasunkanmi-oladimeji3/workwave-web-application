...
export default function AboutUs() {
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="mb-16">
        <div className="grid gap-8 md:grid-cols-2 lg:gap-16 w-4/5 mx-auto">
          <div className="flex flex-col justify-center">
            <h2 className="mb-4 text-3xl font-bold">Our Story</h2>
            <p className="mb-4 text-muted-foreground text-justify">
              Founded in 2025, Workwave emerged from a simple idea: that managing a business should be intuitive, efficient, and even enjoyable. Our founders, seasoned entrepreneurs themselves, experienced firsthand the challenges of juggling multiple tools and platforms to run their operations.
            </p>
            <p className="mb-4 text-muted-foreground text-justify">
      ...
      <section className="mb-16 bg-muted py-16 px-4 md:px-6">
        <h2 className="mb-8 text-center text-3xl font-bold">Our Values</h2>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 px-11 mx-auto">
          {[
  ...
  <div className="grid justify-center gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto">
    {[
      {name: "Olasunkanmi Oladimeji",role: "CEO & Co-founder",image: "/placeholder.svg?height=300&width=300",},
